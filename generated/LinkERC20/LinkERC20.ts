...
export class LinkERC20 extends ethereum.SmartContract {
  static bind(address: Address): LinkERC20 {
    return new LinkERC20("LinkERC20", address);
  }
  ...
  decreaseApproval(spender: Address, subtractedValue: BigInt): boolean {
    let result = super.call(
      "decreaseApproval",
  ...
  increaseApproval(spender: Address, addedValue: BigInt): boolean {
    let result = super.call(
      "increaseApproval",
